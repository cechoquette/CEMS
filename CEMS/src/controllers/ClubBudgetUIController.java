...
//		choiceClubBudgetClub.getItems().addAll(Arrays.asList(OptionLists.getClubs()));//use for testing only
		choiceClubBudgetClub.getItems().addAll(FXCollections.observableList(OptionLists.getAllClubsList()));
